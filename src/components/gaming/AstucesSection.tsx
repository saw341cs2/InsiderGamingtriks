      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white mb-4">
            News Astuces & <span className="text-red-500">Guides</span>
          </h2>
        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-4 md:p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            >
              ...
              <option value="general">FPS General</option>
            </select>
            <select
        ...
        <div className="flex items-center justify-between mb-6">
          <p className="text-gray-500 text-sm">
            <span className="text-white font-semibold">{filtered.length}</span> astuce{filtered.length !== 1 ? 's' : ''} trouvee{filtered.length !== 1 ? 's' : ''}
          </p>
          <button onClick={loadAstuces} disabled={loading} className="text-sm text-gray-400 hover:text-white transition-colors disabled:opacity-50">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    >
                      {astuce.isPremium ? (
                        <><Lock className="w-4 h-4" />Debloquer Premium</>
                      ) : isDownloaded ? (
                        <><Unlock className="w-4 h-4" />Telecharge</>
                      ) : (
                        <><Download className="w-4 h-4" />Telecharger Gratuit</>
                      )}
                    </button>
                  </div>
                </div>
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-lg">Aucune astuce trouvee.</p>
            <button
        ...
        {!loading && filtered.length > 0 && (
          <div className="text-center mt-10">
            ...
            >
              Voir toutes les astuces et anciennes news
            </a>
          </div>
        )}
      </div>
