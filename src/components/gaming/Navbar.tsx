...
<svg className="w-5 h-5 text-red-500" style={{width: '20px', height: '20px', minWidth: '20px', minHeight: '20px'}} fill="currentColor" viewBox="0 0 24 24"></svg>
            ...
            <div className="hidden md:flex items-center gap-3">
               ...
               <a href="https://x.com/InsiderGamingTr" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-300 hover:text-white transition-colors flex-shrink-0" title="X">
                 <svg className="w-5 h-5" style={{width: '20px', height: '20px', minWidth: '20px', minHeight: '20px'}} fill="currentColor" viewBox="0 0 24 24">
                   <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                 </svg>
               </a>
               <a href="https://www.tiktok.com/@insidergamingtricks2" target="_blank" rel="noopener noreferrer" className="p-2 text-pink-500 hover:text-pink-400 transition-colors flex-shrink-0" title="TikTok">
                 <svg className="w-5 h-5" style={{width: '20px', height: '20px', minWidth: '20px', minHeight: '20px'}} fill="currentColor" viewBox="0 0 24 24">
               ...
               <div className="flex items-center gap-4 pt-4 border-t border-gray-800 mt-4">
                <a
                  ...
                  >
                   ...
                   <a href="https://discord.gg/X6D6zzrTf" target="_blank" rel="noopener noreferrer" className="p-2 text-indigo-500 hover:text-indigo-400 transition-colors flex-shrink-0">
                    <svg className="w-5 h-5" style={{width: '20px', height: '20px', minWidth: '20px', minHeight: '20px'}} fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1276 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189Z"/>
                    </svg>
                  </a>
                  <a href="https://x.com/InsiderGamingTr/likes" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-300 hover:text-white transition-colors flex-shrink-0">
                    <svg className="w-5 h-5" style={{width: '20px', height: '20px', minWidth: '20px', minHeight: '20px'}} fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                    </svg>
                  </a>
                  <a href="https://www.tiktok.com/@insidergamingtricks2" target="_blank" rel="noopener noreferrer" className="p-2 text-pink-500 hover:text-pink-400 transition-colors flex-shrink-0">
                    <svg className="w-5 h-5" style={{width: '20px', height: '20px', minWidth: '20px', minHeight: '20px'}} fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/>
                    </svg>
                  </a>
