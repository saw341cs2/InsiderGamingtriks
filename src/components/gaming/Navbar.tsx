      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-md border-b border-red-900/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <div
              className="nav-scroll hidden md:flex items-center gap-0.5 ml-3 lg:ml-6 overflow-x-auto"
            ...
            >
              {navItems.map((item) => (
                <button
                  ...
                  className={`px-1.5 lg:px-2 py-2 text-[11px] lg:text-xs xl:text-sm font-semibold uppercase tracking-wide transition-all duration-200 rounded whitespace-nowrap flex-shrink-0 ${
            ...
            <div className="hidden md:flex items-center gap-1 lg:gap-2 flex-shrink-0 ml-auto pl-2 lg:pl-4">
