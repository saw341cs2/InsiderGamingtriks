      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-md border-b border-red-900/40">
        <div className="max-w-full mx-auto px-0">
          <div className="flex items-center justify-between h-14 px-1">
            ...
            <div className="hidden md:flex items-center gap-0.5 flex-1 min-w-0 overflow-x-auto scrollbar-none mx-1">
              {navItems.map((item) => (
                <button
                  key={item.id}
                  onClick={() => onNavigate(item.id)}
                  className={`whitespace-nowrap px-2.5 py-1.5 text-xs font-semibold uppercase tracking-wider transition-all duration-200 rounded ${
            ...
            <div className="hidden lg:flex items-center gap-1 flex-shrink-0">
              <a href="https://www.youtube.com/@InsiderHackGaming" target="_blank" rel="noopener noreferrer" className="p-1.5 text-red-500 hover:text-red-400 transition-colors flex-shrink-0" title="YouTube">
              ...
              <a href="https://discord.gg/PPgXeC2ZW" target="_blank" rel="noopener noreferrer" className="p-1.5 text-red-500 hover:text-red-400 transition-colors flex-shrink-0" title="Discord">
                <svg className="w-4 h-4 flex-shrink-0" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://x.com/InsiderGamingTr/likes" target="_blank" rel="noopener noreferrer" className="p-1.5 text-gray-300 hover:text-white transition-colors flex-shrink-0" title="X">
                <svg className="w-4 h-4 flex-shrink-0" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.tiktok.com/@insidergamingtricks2?lang=fr" target="_blank" rel="noopener noreferrer" className="p-1.5 text-pink-500 hover:text-pink-400 transition-colors flex-shrink-0" title="TikTok">
                <svg className="w-4 h-4 flex-shrink-0" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
              ...
              {user && (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex items-center gap-1 px-2 py-1.5 bg-gray-800/50 border border-gray-700 rounded-lg hover:bg-gray-700 transition-colors">
              ...
              {!loading && !user && (
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1.5 bg-gray-800 hover:bg-gray-700 text-white text-xs font-medium rounded-lg transition-colors"
                >
              ...
              <button
                ...
                className="px-3 py-1.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white text-xs font-bold uppercase tracking-wider rounded transition-all duration-200 shadow-lg shadow-red-900/30"
              >
                Go Premium
              </button>
            </div>
