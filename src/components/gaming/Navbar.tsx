        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-2 flex-shrink-0">
              <a href="https://www.youtube.com/@InsiderHackGaming" target="_blank" rel="noopener noreferrer" className="p-2 text-red-500 hover:text-red-400 transition-colors flex-shrink-0" title="YouTube">
              ...
              <a href="https://discord.gg/X6D6zzrTf" target="_blank" rel="noopener noreferrer" className="p-2 text-red-500 hover:text-red-400 transition-colors flex-shrink-0" title="Discord">
                <svg className="w-5 h-5 flex-shrink-0" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://x.com/InsiderGamingTr/likes" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-300 hover:text-white transition-colors flex-shrink-0" title="X">
                <svg className="w-5 h-5 flex-shrink-0" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.tiktok.com/@insidergamingtricks2?lang=fr" target="_blank" rel="noopener noreferrer" className="p-2 text-pink-500 hover:text-pink-400 transition-colors flex-shrink-0" title="TikTok">
                <svg className="w-5 h-5 flex-shrink-0" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
